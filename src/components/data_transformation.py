...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info("Applying preprocessing object on training datafreame and testing dataframe")
            ...
            save_object(
                file_path = self.data_tarnsformation_config.preprocessor_obj_file_path,
            ...
            return(
                train_arr,
                test_arr,
                self.data_tarnsformation_config.preprocessor_obj_file_path
            )
        except Exception as e:
            raise CustomException(e,sys)
